...
@WebServlet(urlPatterns = {"/oauthDialog/*"})
public class OauthDialogServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String  OauthUrl = OAuthService.getOauthUrl(uri, "utf-8", "snsapi_userinfo");
